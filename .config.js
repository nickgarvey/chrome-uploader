...
module.exports = {
  ...
  API_URL: process.env.API_URL || 'https://dev-api.tidepool.org',
  UPLOAD_URL: process.env.UPLOAD_URL || 'https://dev-uploads.tidepool.org',
  DATA_URL: process.env.DATA_URL || 'https://dev-api.tidepool.org/dataservices',
  BLIP_URL: process.env.BLIP_URL || 'https://dev-app.tidepool.org',
